...
class ClawPincherServo(PositionalServoBase):
    def __init__(self):
        super().__init__("clawPincher")

    def close(self) -> float:
        return self.move_to_named("close")

    def open(self) -> float:
        return self.move_to_named("open")

    def latched(self) -> float:
        return self.move_to_named("latched")


def print_help(servo: ClawPincherServo) -> None:
    print(f"""
Config file: {CONFIG_PATH}
Servo key: clawPincher
