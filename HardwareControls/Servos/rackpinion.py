...
class RackPinionServo(PositionalServoBase):
    def __init__(self):
        super().__init__("rackpinion")

    def lower(self) -> float:
        return self.move_to_named("lower")

    def raise_up(self) -> float:
        return self.move_to_named("raise")

    def center(self) -> float:
        return self.move_to_named("center")


def print_help(servo: RackPinionServo) -> None:
    print(f"""
Config file: {CONFIG_PATH}
Servo key: rackpinion
