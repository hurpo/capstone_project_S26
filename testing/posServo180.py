#!/usr/bin/env python3
"""
PCA9685 positional servo controller (180° mapping)
...
def print_help():
    print("""
180° Servo Commands:
  angle <deg>              -> command 0..180 degrees
  center                   -> go to 90 degrees
...
- Then calibrate range so 0° and 180° land where you want:
  range 800 2200
""")
...
def main():
    servo = Servo180()
    print("PCA9685 180° servo controller (channel 0). Type 'help'.")
    ...
    try:
        while True:
            ...
            if cmd in ("quit", "exit"):
                ...
                pulse = servo.center()
                print(f"Centered at 90° -> {pulse:.0f} us")
