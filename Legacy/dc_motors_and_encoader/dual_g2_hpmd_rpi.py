...
class Motor(object):
    ...
    def __init__(self, ina_pin, inb_pin, pwm_pin): #en_diag_pin
        ...
        # _pi.set_mode(self.en_pin, pigpio.INPUT)
        # _pi.set_pull_up_down(self.flt_pin, pigpio.PUD_UP)
    ...
    def setSpeed(self, speed):
        ...
        _pi.hardware_PWM(self.pwm_pin, 1000, int(abs(speed)*6250 /3 ))
...
class Motors(object):
    ...
    def forceStop(self):
        ...
        global _pi
        _pi.hardware_PWM(_pin_M1PWM, 0, 0)
        _pi.hardware_PWM(_pin_M2PWM, 0, 0)
        _pi.write(_pin_M1INA, 0)
        _pi.write(_pin_M2INA, 0)
        _pi.write(_pin_M1INB, 0)
        _pi.write(_pin_M2INB, 0)
        _pi.stop()
        _pi = pigpio.pi()
        self.setSpeeds(0, 0)
